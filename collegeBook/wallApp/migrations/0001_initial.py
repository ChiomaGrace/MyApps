# Generated by Django 2.2.4 on 2021-02-03 19:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
                ('listOfFriends', models.ManyToManyField(through='wallApp.friendRequest', to='wallApp.User')),
            ],
        ),
        migrations.CreateModel(
            name='Message',
        ...
        migrations.AddField(
            ...
            name='receiverOfFriendRequest',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='receiver', to='wallApp.User'),
        ),
        migrations.AddField(
            model_name='friendrequest',
            name='senderOfFriendRequest',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sender', to='wallApp.User'),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
